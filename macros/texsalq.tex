...
\mtdef {symbols}      {LIST OF SYMBOLS}   {LISTA DE SÕMBOLOS} {}
...
\addto\makefront{%
     \cleardoublepage\toapages \vfil\break %comentar essa linha se nao houver abreviaÁıes
}
\def\tospages{
   \twelveonehalf%
...
\addto\makefront{%
     \cleardoublepage\tospages \vfil\break %comentar essa linha se nao houver sÌmbolos
}
