...
The differences between the two models is mostly due to the consideration of steady-state condition in respect of water flow, that provides constant water flux and solute dispersion coefficient.
As the analytical model is a solution to the Equation \ref[eq_cush] with a linear boundary condition of solute uptake at the root surface (Equation \ref[eq_bc_cush]), it is also shown in Figure \ref[fig_analytic] the result of the linear numerical model (LU, grey line).
