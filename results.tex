...
We found that, as a rule, a small time step of 0.01 s can be used when the default space step (Section \ref[scenarios]) is used. 
{\tred When a smaller space step is necessary, smaller values of $\Delta t$ are required. 
{\tblue
The Von Neumann stability analysis \cite[neumann] shows that a good criteria to chose space and time steps is $\displaystyle{D \Delta t \over {\Delta r}^2} \leq \displaystyle{ 1 \over 2}$ (using the symbology of this thesis).
...
{\tblue Figure \ref[fig_phases] shows how they are represented. {\it IMPROVE IT !!}}
...
\caption/f {{\tblue Schematic representation of the phases LUP, CUP and NUP}}
\medskip
...
\caption/f {{\tblue Relative transpiration and solute concentration at the root surface as a function of time. (1)~indicates the onset of the $T_r$ falling rate phase and (2)~indicates the onset of the $C_0$ falling rate phase}}
\medskip
