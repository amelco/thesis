...
A plant controlled process allowing the reduction of solute uptake (for example, a 
{\tred 
reflection coefficient that indicates how effectively the osmotic pressure of a solute can be exerted across a membrane \cite[nobel])
