...
Therefore, averages for the simulated water flux and dispersion coefficient of scenario 1 were calculated to serve as an inputs in the analytical model.
%In the numerical model, the dispersion coefficient changes in time and distance.
%Therefore, to get similar concentration profiles, the analytical model had a value of $D=1.98 \cdot 10^{-11}$ m$^2$ s$^{-1}$ whereas the numerical model had dispersion coefficients that ranged from $4.13 \cdot 10^{-10}$ to $1.25\cdot10^{-12}$ m$^2$ s$^{-1}$ at the root surface.
