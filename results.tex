...
According to Equations \ref[eq_MM_mod] and \ref[eq_MM_linear], the difference between LU and NLU occurs only at root surface concentration values below $C_{lim}$. 
For the chosen scenario, this situation occurred at nearly the fourth simulated day.
The absolute and relative difference between the estimated solute concentration for the linear (CL) and nonlinear (CNL) model was calculated according to Equations \ref[error_abs] and \ref[error_rel], respectively.
