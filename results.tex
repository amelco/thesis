...
In this section, the results of the main output variables ($C(r)$, $C_0(t)$ and $T_r(t)$) are presented for each scenario, as well as the active and passive contributions to uptake.
