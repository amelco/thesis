...
{\tblue In this section, the predictions of the ZU, the CU and the analytical model are shown, for Scenario 1, in comparison to the nonlinear model. }
...
The proposed numerical model is compared to the analytical model of \citeonline[cushman], in Figure \ref[fig_analytic], with input parameters of scenario 1.
...
\caption/f {Solute concentration profile predicted by the analytical model of \citeonline[cushman] (bold line) and by the nonlinear (thin black line) and linear (thin grey line) numerical models, with parameters of scenario 1, at time $t=30$ days}
\medskip
