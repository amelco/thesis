...
For the case of NLU, an accumulation period does not happen because of the high solute uptake rate in LUP (all solute carried by mass flow of water is taken up).
The time needed to $C_2$ increases until it becomes higher than $C_0$ (explained in the last section) generates a delay between the onset of the $T_r$ falling rate phase and the time that $C_0$ starts to diminish (Figure \ref[fig_heads2]).
