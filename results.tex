...
\caption/f {Active and passive contributions to the solute uptake as a function of time. Thicker continuous line represents the total uptake (active+passive)}
\medskip
...
{\localcolor\Red The simulation scenario 7 presented different results when compared to the others due to clay soil. Figure \ref[fig_contrib_c] showns that the three phases are present in all scenarios, excepting scenario 7. The water flux is small due to the hydraulic properties of the clay soil which causes also a small solute uptake. 
...
{\localcolor\Red According to \citeonline[tinker], at low concentrations, the ion transport across membranes is limited by the diffusive flux of solute towards the membrane in case of high affinity uptake (low $K_m$ values) and
