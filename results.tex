...
%
{\tred The differences between the two models is mostly due to the consideration of steady-state condition in respect to water flow in the analytical model {\it QM: Para fazer uma comparacao justa, deveria rodar o modelo numerico para as condicoes de contorm do modelo analitoco. Assim, daria para, realmente comparar.}} as opposed to the proposed numerical model that deals with transient water and solute fluxes.
...
These results need confrontation with experimental data of {\tred solute uptake of non-stressed plants to verify whether a plant regulated mechanism of uptake should be added to the model. {\it QM: There must be literature on these mechanisms. Cite some.}}
