...
CU presents the same behaviour with a slightly lower $C_0$ value. 
The difference between ZU and CU concentrations increases as the water flux decreases.
As higher the value for the constant uptake rate in CU, more close to the NLU plot it becomes.
...
For ZU and CU the concentration starts to diminish when $T_r<1$ due to $H_0=-150$ m (Figure \ref[fig_heads1]).
For the case of NLU, there is a delay for $C_0$ starts to decrease after $TR<1$, which is the time needed to $C_2$ increases until it becomes higher than $C_0$ (Figure \ref[fig_heads2]).
