...
according respectively to Equations \ref[eq_bcw1] and \ref[eq_bcw2] as follows:
$$
\eqalignno{
\label[eq_bcw1]
...
The computer algorithm that solves the Equation \ref [eq_disc_water] and applied boundary conditions \ref[eq_bcw1] and \ref[eq_bcw2] are found on Appendix \ref[ap_water].
...
The uptake of each root equals $-F/R$ (mol d$^{-1}$, the negative sign indicating solute depletion), thus, the condition at root surface is described by:
$$
\eqalignno{
