...
Here, we did a decrement of 1\% of the following selected parameters ($P$): a) MM parameters $I_m$, $K_m$; and  b) soil hydraulic parameters $\alpha$, $n$, $\lambda$, $K_s$, $\theta_r$ and $\theta_s$.
