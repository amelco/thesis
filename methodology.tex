...
* At a soil solution concentration value \clim, the solute flux limits the uptake. {\it QM: Ainda pode melhorar. Nao sei se estah 100\% claro.}}
\enditems
...
{\tblue The set of parameters $h_{ini}$ and $C_{ini}$ was chosen in a way that the plant is in a no stress condition ($T_r=1$).
All simulation scenarios ended when $T_r \leq 0.001$ where the water uptake is considered negligible.}
