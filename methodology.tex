...
Computational implementations of the analytical models of \citeonline[cushman] and \citeonline[willigen1] were made to confront them with the numerical solutions. The former uses the MM equation as the boundary condition at root surface to deal with solute uptake, and is used to compare with the proposed nonlinear model (NLU).
