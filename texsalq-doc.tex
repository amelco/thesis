...
\abstractPT {%
 Uma modificação em um modelo de extração de água e transporte de solutos foi realizada com o objetivo de incluir a extração de soluto pelas raízes.
...
O modelo considera uma raíz singular com geometria radial sendo sua superfície a condição de contorno (limite) de extração e o limite extremo sendo a meia-distância entre raízes vizinhas e função da densidade radicular.
...
As contribuições ativa e passiva da extração de solutos variam com parâmetros relacionados à espécie de ion, à planta, à atmosfera e às propriedades hidráulicas do solo.
O modelo apresentou uma boa concordância com um modelo analítico que usa uma condição de contorno linear, à superfície da raiz, de extração de solutos dependente da concentração no solo.
