...
2A. Root segment ($i=1$) with flux boundary condition, applied while $h_1 > h_{lim}$, i.e., when transpiration meets potential transpiration demand:
$$
\eqalignno{
...
2B. Root segment ($i=1$) with head boundary condition, applied while $h_1 = h_{lim}$, i.e., when transpiration is less than potential transpiration demand:
$$
\eqalignno{
