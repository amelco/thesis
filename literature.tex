...
As solute presence in soil solution contributes to reduce the total hydraulic head -- decreasing root water uptake -- the effect in transpiration reduction by water and salt stress are commonly related to be either additive 
%\cite[vangenuchten87] 
or multiplicative 
%\cite[vangenuchten87] 
in many models. 
