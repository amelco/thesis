...
For the high concentration range, solutes are freely transported from soil to roots by diffusion and occasional convection. This passive transport is known as Epstein's mechanism~II \cite[kochian,siddiqi]. Details of Epestein's mechanisms are found on \citeonline[epstein60].
...
The addition of the new parameters changes the solute uptake rate as shown in Figure \ref[MM_plus]. By the fact that the solute uptake rate acts in distinct ways for different solute concentration ranges of the external medium, the modified MM equation may be considered a stepwise function. In the process of the development of the nutrient uptake models, some authors have used the modified MM equation to estimate both passive and active uptake while others use the original equation to deal with active uptake only \cite[shi].
