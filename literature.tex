...
The rate of solute uptake by plant roots can be referred to be similar to that between enzyme and its substrate. 
\citeonline[epstein52] used the  Michaelis-Menten equation \cite[michaelis] to define the uptake of a solute and its concentration in external medium, for potassium and sodium solutions in barley roots. The most well-known form of the equation is the following:
\label[eq_MM]
$$
