...
Solute transport in soil is driven by processes of diffusion and convection.
Similarly as with water, solute flow within the soil is driven by a gradient between the root and the surrounding soil proportional to the diffusivity that, in turn, varies basically with soil water content. 
The diffusion coefficient determines the velocity of solute movement at a given gradient and is composed of the molecular diffusion and the mechanical dispersion coefficients. 
