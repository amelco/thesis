...
Figure \ref[MM_plus] shows the effects of the new parameters on original MM equation. The Equation \ref[eq_MM_plus] is used in many solute uptake models () instead of the original equation.
