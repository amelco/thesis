...
Microscopic models \cite[barber74,cushman,willigen1,roose] consider a single cylindrical root, of uniform radius and absorption properties \cite[gardner], that extracts water and solute by an axisymmetric flow according to the defined boundary condition at root surface.
